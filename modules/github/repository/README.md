...
| [github_issue_labels.labels](https://registry.terraform.io/providers/integrations/github/latest/docs/resources/issue_labels) | resource |
...
| <a name="input_labels"></a> [labels](#input\_labels) | List of labels for the GitHub repository. | <pre>list(object({<br/>    name        = string<br/>    color       = string<br/>    description = optional(string)<br/>  }))</pre> | `[]` | no |
